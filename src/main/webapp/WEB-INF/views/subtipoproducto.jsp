...
<div class="container mt-4">
  <div class="row">
  <c:forEach var="bean" items="${substipproductos}">
    <div class="col-sm-4">
      <div class="card">
        <div class="card-header">
          <label>${bean.nom_subTipPro}</label>
        </div>
        <div class="card-body" align="center">
          <a href="prodxsubtipo?codigotipo= + ${bean.codTipPro}"><img src="verFotoSubTipPro?codigo= + ${bean.codTipPro}" width="200" height="180"></a>
        </div>
        </div>
    </div>
    </c:forEach>
