...
<div class="container mt-4">
  <div class="row">
  <c:forEach var="bean" items="${tipProductos}">
    <div class="col-sm-4">
      <div class="card">
        <div class="card-header">
          <label>${bean.nomTipProd}</label>
        </div>
        <div class="card-body" align="center">
          <a href="subtipprod?codigosubtipo= + ${bean.codTipProd}"><img src="verFotoTipProducto?codigo= + ${bean.codTipProd}" width="200" height="180"></a>
        </div>
        </div>
    </div>
    </c:forEach>
